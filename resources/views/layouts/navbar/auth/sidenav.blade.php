<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px; min-height:100vh;">
    ...
    <div class="dropdown">
        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
            ...
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3HEsnAcK619VqUrvnTltbhxTHZzmwnltgfbgzf-VP03fsfIbf" alt="" width="32" height="32"
                class="rounded-circle me-2">
            <strong>Wahyuda</strong>
        </a>
